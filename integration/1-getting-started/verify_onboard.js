...
cy.xpath("//input[@name='password']").type(Cypress.env("pwd"));
...
//Sleep Score
cy.get('.sl-score').should('be.visible') 


//Tailor program
cy.xpath('//*[@id="sl-flow"]/div[3]/div/div/div/div/div/table/tbody/tr/td/div[2]/div[4]/a').click()
cy.xpath('//*[@id="16_4"]').click

//Logout
cy.xpath('//*[@id="sl-flow"]/header/div/a[2]').click()
})
